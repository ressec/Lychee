...
/**
 * Unchecked exception thrown to indicate an error occurred during a localization operation.
 * @author <a href="mailto:christophe.resse@gmail.com">Christophe Resse</a>
 * @version 1.0.0
 */
public class LocalizationException extends AbstractUncheckedException
{
    /**
    ...
    /**
     * Thrown to indicate that an error during a localization operation.
